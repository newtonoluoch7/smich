...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="images/smichfavi.png" />
    <title>Smich Pharma &#8211; Ke</title>
        ...
        <div class="page_wrap">
                    ...
                    <div class="top_panel_middle">
                        <div class="content_wrap">
                            <div class="contact_logo">
                                <div class="logo">
                                    <a href="index.php">
                                        <img src="images/Smich Logo.png" class="logo_main" alt="" width="202" height="49" style="width: 170px;">
                                        <img src="images/Smich Logo.png" class="logo_fixed" alt="" width="173" height="42">
                                    </a>
                                </div>
                            </div>
                                    ...
                                    <ul id="menu_main" class="menu_main_nav">
                                        ...
                                        <li class="menu-item menu-item-has-children"><a href="#"><span>PRODUCTS</span></a>
                                            <ul class="sub-menu">
                                                ...
                                                <li class="menu-item"><a href="shop.php"><span>Pain relief sprays</span></a></li>
                                                <li class="menu-item"><a href="shop.php"><span>Cardiology products</span></a></li>
            ...
            <div class="header_mobile">
                <div class="content_wrap">
                    ...
                    <div class="logo">
                        <a href="index.php">
                            <img src="images/Smich Logo.png" class="logo_main" alt="" width="202" height="49">
                        </a>
                    </div>
                </div>
                <div class="side_wrap">
