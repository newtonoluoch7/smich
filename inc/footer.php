                        ...
                        <div class="columns_wrap">
                            <aside class="column-1_3 widget widget_socials">
                                <div class="widget_inner">
                                    <div class="logo">
                                        <a href="index.php" >
                                            <img src="images/Smich Logo.png" class="logo_main" alt="" width="150" height="39" style="width: 150px;">
                                        </a>
                                    </div>
                                    <div class="logo_descr">
                                        Smich pharma is a local pharmaceutical company offering tailored
